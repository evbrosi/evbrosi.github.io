...
var azDemocrats = [727687, 775537, 872210, 955633, 1036817, 1088709, 1092141];
var azRepublicans = [662124, 714106, 843244, 937486, 1034082, 1099789, 1101641];
var azIndependents = [88815,  95923,  111730, 129325, 145156, 154661, 154899];

var gaDemocrats = [1127028, 1203359, 1284839, 1367047, 1455074, 1530501, 1530501];
var gaRepublicans = [1255877, 1330288, 1446393, 1562760, 1678728, 1776130, 1776130];
var gaIndependents = [172140, 185093, 201942, 219538, 238009, 254578, 254578];

var flDemocrats = [2703172, 2839748, 2998368, 3183118, 3367655, 3541847, 3541847];
var flRepublicans = [2524687, 2667026, 2885185, 3126037, 3350302, 3563458, 3563458];
var flIndependents = [378400, 400470, 428808, 463262, 497670, 531157, 531157];

var miDemocrats = [864367, 925885, 980819, 1014367, 1059732, 1059732, 1109954];
var miRepublicans = [767532,  820683, 879718, 915148, 962716, 962716, 1011788];
var miIndependents = [382752, 409211, 437560, 453811, 476691, 476691, 500389];

var mnDemocrats = [566700, 575641, 600793, 632879, 663680, 695641, 695641];
var mnRepublicans = [362082,  364252, 389865, 419452, 447514, 477834, 477834];
var mnIndependents = [273319, 274636, 290878, 308394, 326165, 344682, 344682];

var ncDemocrats = [1519115,  1552973, 1647835, 1732689, 1823212, 1832158, 1915076];
var ncRepublicans = [1344880,  1378065, 1501176, 1613318, 1732275, 1740248, 1848743];
var ncIndependents = [190515, 195179, 211452, 226235, 243165, 245826, 262321];

var ohDemocrats = [902605,  950118, 1009652, 1063669, 1117579, 1174300, 1218577];
var ohRepublicans = [993819,  1039350, 1119723, 1188383, 1260171, 1338051, 1398479];
var ohIndependents = [271433, 284839, 307304, 326753, 345748, 370009, 388401];

var paDemocrats = [925638,  1096538, 1172784, 1249297, 1323538, 1323538, 1426987];
var paRepublicans = [391722,  478173, 527514, 567613, 616235, 616235, 679334];
var paIndependents = [104255, 127404, 138506, 148313, 162089, 162089, 175429];

var txDemocrats = [2609755,  2710428, 2930211, 3007296, 3293048, 3462626, 3471272];
var txRepublicans = [3487232, 3628581, 3906024, 3996550, 4366847, 4567597, 4582809];
var txIndependents = [617128, 647539, 711543, 743315, 830513, 881027, 883616];

var wiDemocrats = [511245, 528962, 562167, 592089, 640488, 640488, 684655];
var wiRepublicans = [470977, 478982, 521859, 559722, 606777, 606777, 662056];
var wiIndependents = [290311, 294884, 317180, 336590, 369073, 369073, 398990];
